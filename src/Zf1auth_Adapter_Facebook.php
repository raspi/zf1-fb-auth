...
class Zf1auth_Adapter_Facebook implements \Zend_Auth_Adapter_Interface
{
    ...
    public function authenticate()
    {
        ...
        } catch (\Facebook\FacebookSDKException $e)
        {
            ...
            {
                if ($e instanceof \Facebook\FacebookAuthorizationException)
                {
                    if (100 === $e->getCode())
                    {
            ...
            return new Zf1auth_Zend_Auth_Result(\Zend_Auth_Result::FAILURE, null, array('Facebook error: ' . $e->getMessage()));
        }
        ...
        if (null === $fbses)
        {
            ...
            return new Zf1auth_Auth_Result(\Zend_Auth_Result::FAILURE, null, $errs);
        }
        ...
        if (!$fbses instanceof \Facebook\FacebookSession)
        {
            ...
            return new Zf1auth_Auth_Result(\Zend_Auth_Result::FAILURE, null, array($err));
        }

        if (!$fbses->validate())
        {
            return new Zf1auth_Auth_Result(\Zend_Auth_Result::FAILURE, null, array('Invalid Facebook session'));
        }
        ...
        return new Zf1auth_Auth_Result(\Zend_Auth_Result::SUCCESS, $o, array());
    }
